...
#
# Generated by export_simulation on Mon Nov 30 13:39:45 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './mips_tb.sh' script.

./mips_tb.sh -reset_run
...
./mips_tb.sh -noclean_files

For more information on the script, please type './mips_tb.sh -help'.
